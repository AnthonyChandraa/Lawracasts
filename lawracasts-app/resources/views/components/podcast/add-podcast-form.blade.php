<div x-show="isAddPodcastOpen"  x-transition.opacity x-cloak id="authentication-modal"
    ...
    md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button @click="toggleAddPodcast()" type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent
            hover:bg-gray-200
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Add Podcast</h3>
                <form class="space-y-6" action="{{route('add_podcast')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        text-white
                        rounded-md" placeholder="Enter Podcast Description..."></textarea>
                    </div>

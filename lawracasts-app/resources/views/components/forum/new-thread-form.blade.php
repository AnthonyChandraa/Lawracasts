<div x-show="isAddThreadOpen"  x-transition.opacity x-cloak id="authentication-modal"
    ...
    md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button @click="toggleAddThread()" type="button" class="absolute top-3 right-2.5 text-gray-400
            bg-transparent
            hover:bg-gray-200
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Add Thread</h3>
                <form class="space-y-6" action="{{route('add_forum')}}" method="post">
                    @csrf
                    <div>
                        <label for="title" class="block mb-2 text-sm font-medium text-gray-900
                        dark:text-white">Thread title</label>
                    ...
                    dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Thread</button>
                </form>
            </div>
        </div>
    </div>
